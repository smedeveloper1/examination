...
#                   x      y      z   rx  ry  rz
    ...
    B1L=np.array([-114,-203+20,  50,  90,  0,  0])
    B1R=np.array([  89,-203+20,  50,  90,  0,  0])
...
# for test (to B1L)up
        print("===== 1 ==> B1Lup")
        mycobot.send_coords(B1L, speed,0)
        time.sleep(wait)
        print("upB1L=",B1L)
        print("gtB1L=",np.array(mycobot.get_coords()))
        print("upB1L-gtB1L=",B1L-np.array(mycobot.get_coords()))
...
# for test (to B1L)up
        ...
        mycobot.send_coord(Coord.Z.value,up_height, 10)
        time.sleep(wait+1)
        print("upB1L,Z=",B1L,up_height)
        print("gtB1L=",np.array(mycobot.get_coords()))

############################################################################
############################################################################

# for test (from B1L to B1R)up
        print("===== 4 ==> B1Lup =>C1Rup")
        mycobot.send_coords(B1R, speed,0)
        time.sleep(wait)
        print("upB1R",B1R)
        print("gtB1R=",np.array(mycobot.get_coords()))
        print("upB1R-gtB1R=",B1R-np.array(mycobot.get_coords()))

# for test (from B1L to B1R)set
        print("===== 5 ==> B1Rset")
        mycobot.send_coord(Coord.Z.value,set_height, 10)
        time.sleep(wait)
        print("upB1R,Z=",B1R,set_height)
        print("gtB1R=",np.array(mycobot.get_coords()))
...
# for test (from B1R to C1R)up
        print("===== 6 ==> B1Rup")
        mycobot.send_coord(Coord.Z.value,up_height,10)
        time.sleep(wait)
        print("upB1R,Z=",B1R,up_height)
        print("gtB1R=",np.array(mycobot.get_coords()))
...
#                x              y       z     rx     ry    rz
        ...
        B1L=[B1L[0]+x_shift, B1L[1],B1L[2],B1L[3],B1L[4],B1L[5]]
        B1R=[B1R[0]+x_shift, B1R[1],B1R[2],B1R[3],B1R[4],B1R[5]]
