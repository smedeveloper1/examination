...
# speed setting
    ...
    for i in range(1000):
        ...
        print("No",i,"j1-j6_value:",j1,j2,j3,j4,j5,j6)
#        random_j1_j6=[j1,j2,j3,j4,j5,j6]
        np_ran_j1_j6=np.array([j1,j2,j3,j4,j5,j6])
#        print(random_j1_j6)
#        print(np_ran_j1_j6)
#        mycobot.send_angels(random_j1_j6,slow)
        mycobot.send_angles(np_ran_j1_j6,slow)
        print("No",i,"get_angles() ==> {}".format(mycobot.get_angles()))
        print("No",i,"get_coords() ==> {}".format(mycobot.get_coords()))
        time.sleep(5)
