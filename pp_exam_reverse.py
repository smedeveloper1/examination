...
# 2021/12/14
    C5L=np.array([ -66,-168+20,  50,  90,  0,  0])
    C5R=np.array([ 137,-168+20,  50,  90,  0,  0])
...
# for test (to C5L)up
        print("===== 1 ==> C1Lup")
        mycobot.send_coords(C5L, speed,0)
        time.sleep(wait)
        print("upC5L=",i,C5L)
        print("gtC5L=",np.array(mycobot.get_coords()))
        print("upC5L-gtC5L=",C5L-np.array(mycobot.get_coords()))
...
# for test (to C5L)set
        ...
        mycobot.send_coord(Coord.Z.value,set_height, 10) # Z value set
        time.sleep(wait)
        print("upC5L,Z=",i,C5L,set_height)
        print("gtC5L=",np.array(mycobot.get_coords()))
#        print("upC5L-gtC5L=",C5L-np.array(mycobot.get_coords()))
...
#        print("::get_coords() ==> coords: {}".format(mycobot.get_coords()))
        ...
        '''
# for test (from C5L to C5R)up
        print("===== 4 ==> C5Lup =>C5Rup")
        mycobot.send_coords(C5R, speed,0)
#        print("::get_coords() ==> coords: {}".format(mycobot.get_coords()))
        time.sleep(wait)
        print("upC5R",i,C5R)
        print("gtC5R=",np.array(mycobot.get_coords()))
        print("upC5R-gtC5R=",C5R-np.array(mycobot.get_coords()))
...
#        print("upC1R-gtC1R=",C1L-np.array(mycobot.get_coords()))
        '''
# for test (from C5L to C5R)set
        print("===== 5 ==> C1Rset")
        mycobot.send_coord(Coord.Z.value,set_height, 10)
        time.sleep(wait)
        print("upC5R,Z=",i,C5R,set_height)
        print("gtC5R=",np.array(mycobot.get_coords()))
...
#                x              y       z     rx     ry    rz
        ...
        C5L=[C5L[0]-x_shift, C5L[1],C5L[2],C5L[3],C5L[4],C5L[5]]
        C5R=[C5R[0]-x_shift, C5R[1],C5R[2],C5R[3],C5R[4],C5R[5]]
